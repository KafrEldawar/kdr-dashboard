-- ============================================================
-- 038: Surface restaurant phone in rpc_get_order_detail
--
-- The mobile customer's order detail screen needs a one-tap dialer
-- to reach the restaurant. Phones live on `branch_phones`, keyed by
-- `branches.id`. We pick the first phone for the order's branch and
-- fold it into the existing `restaurant` JSON block under a `phone`
-- field. Empty string when no phone is registered for the branch.
-- ============================================================
